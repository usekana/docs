...
HINT: Click on the ‘Live environment’ toggle in the upper right hand corner of the dashboard to switch environments. The dashboard primary colour will be purple when development and green when live.
...
HINT: The generated Kana YAML configuration files will sit within a `kana` folder in your repository.
