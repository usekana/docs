...
<Note>
There's no toggle to enforce that Secure Mode is used currently. You can easily use one method or the other depending on your use-case. If you ever need us to rotate your Public API Key, just let us know and we'll be happy to do so.

</Note>

Here's guides on how to achieve each:
