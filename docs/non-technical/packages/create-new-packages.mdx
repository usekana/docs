...
If the details need changing, See more on the [Editing packages document](/non-technical/packages/edit-an-existing-package).
...
[Edit an existing package](/non-technical/packages/edit-an-existing-package)
