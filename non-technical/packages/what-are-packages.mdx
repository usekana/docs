...
When [creating](/non-technical/packages/create-new-packages) or editing a base package, you can specify which add-on packages users can subscribe to on top of that particular base package. If you specify none, anyone can subscribe to the add-on package irrespective of the base package they are subscribed to.
...
<Card title="What are features?" icon={solid("list-check")} href="/non-technical/features/what-are-features"></Card>
